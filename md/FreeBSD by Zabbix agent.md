# FreeBSD by Zabbix agent template description
...
| {HOST.NAME} has just been restarted | INFO | no description | change(/FreeBSD by Zabbix agent/system.uptime)<0 | [{"tag": "scope", "value": "notice"}] | no url |
