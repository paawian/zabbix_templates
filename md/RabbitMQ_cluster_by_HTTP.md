# RabbitMQ cluster by HTTP template description
...
| ------------- |------------- |------------- |------------- |------------- |
| Get exchanges | The HTTP API endpoint that returns exchanges metrics. | rabbitmq.get_exchanges | HTTP_AGENT | no delay |
| Get overview | The HTTP API endpoint that returns cluster-wide metrics. | rabbitmq.get_overview | HTTP_AGENT | no delay |
...
<a name="discovery_exchanges_discovery" />
