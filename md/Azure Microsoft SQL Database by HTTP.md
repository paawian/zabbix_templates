# Azure Microsoft SQL Database by HTTP template description
...
| Data IO percentage | The percentage of physical data read. | azure.db.mssql.data.read.percentage | DEPENDENT | 0 |
...
| SQL Server process memory percent | Memory usage as a percentage of the SQL DB process. Not applicable to data warehouses. | azure.db.mssql.server.memory.percent | DEPENDENT | 0 |
| Sessions count | The number of active sessions. Not applicable to Synapse DW Analytics. | azure.db.mssql.sessions.count | DEPENDENT | 0 |
...
| Differential backup storage size | Cumulative differential backup storage size. Applies to the vCore-based databases. Not applicable to the Hyperscale databases. | azure.db.mssql.storage.backup.diff.size | DEPENDENT | 0 |
| Log backup storage size | Cumulative log backup storage size. Applies to the vCore-based and Hyperscale databases. | azure.db.mssql.storage.backup.log.size | DEPENDENT | 0 |
