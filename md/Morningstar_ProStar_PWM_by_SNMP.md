# Morningstar ProStar PWM by SNMP template description
...
| ------------- |------------- |------------- |------------- |------------- |
| Array: Voltage | MIB: PROSTAR-PWM<br>Description:Array Voltage<br>Scaling Factor:1.0<br>Units:V<br>Range:[0, 80]<br>Modbus address:0x0013 | array.voltage[arrayVoltage.0] | SNMP_AGENT | no delay |
| Battery: Battery Voltage discovery | MIB: PROSTAR-PWM | battery.voltage.discovery[batteryTerminalVoltage.0] | SNMP_AGENT | 15m |
| Battery: Charge Current | MIB: PROSTAR-PWM<br>Description:Charge Current<br>Scaling Factor:1.0<br>Units:A<br>Range:[0, 40]<br>Modbus address:0x0011 | charge.current[chargeCurrent.0] | SNMP_AGENT | no delay |
| Battery: Charge State | MIB: PROSTAR-PWM<br>Description:Control State<br>Modbus address:0x0021<br><br>0: Start<br>1: NightCheck<br>2: Disconnect<br>3: Night<br>4: Fault<br>5: Bulk<br>6: Pwm<br>7: Float<br>8: Equalize | charge.state[chargeState.0] | SNMP_AGENT | no delay |
| Counter: Charge Amp-hours | MIB: PROSTAR-PWM<br>Description:Ah Charge (Resettable)<br>Scaling Factor:0.1<br>Units:Ah<br>Range:[0.0, 4294967294]<br>Modbus addresses:H=0x0026 L=0x0027 | counter.charge_amp_hours[ahChargeResettable.0] | SNMP_AGENT | no delay |
| Counter: Charge KW-hours | MIB: PROSTAR-PWM<br>Description:Kilowatt Hours Charge (Resettable)<br>Scaling Factor:1.0<br>Units:kWh<br>Range:[0.0, 65535]<br>Modbus address:0x002A | counter.charge_kw_hours[kwhChargeResettable.0] | SNMP_AGENT | no delay |
| Counter: Load Amp-hours | MIB: PROSTAR-PWM<br>Description:Ah Load (Resettable)<br>Scaling Factor:0.1<br>Units:Ah<br>Range:[0.0, 4294967294]<br>Modbus addresses:H=0x0032 L=0x0033 | counter.load_amp_hours[ahLoadResettable.0] | SNMP_AGENT | no delay |
| Load: Current | MIB: PROSTAR-PWM<br>Description:Load Current<br>Scaling Factor:1.0<br>Units:A<br>Range:[0, 60]<br>Modbus address:0x0016 | load.current[loadCurrent.0] | SNMP_AGENT | no delay |
| Load: State | MIB: PROSTAR-PWM<br>Description:Load State<br>Modbus address:0x002E<br><br>0: Start<br>1: Normal<br>2: LvdWarning<br>3: Lvd<br>4: Fault<br>5: Disconnect<br>6: NormalOff<br>7: Override<br>8: NotUsed | load.state[loadState.0] | SNMP_AGENT | no delay |
| Load: Voltage | MIB: PROSTAR-PWM<br>Description:Load Voltage<br>Scaling Factor:1.0<br>Units:V<br>Range:[0, 80]<br>Modbus address:0x0014 | load.voltage[loadVoltage.0] | SNMP_AGENT | no delay |
| Status: Alarms | MIB: PROSTAR-PWM<br>Description:Alarms<br>Modbus addresses:H=0x0038 L=0x0039 | status.alarms[alarms.0] | SNMP_AGENT | no delay |
| Status: Array Faults | MIB: PROSTAR-PWM<br>Description:Array Faults<br>Modbus address:0x0022 | status.array_faults[arrayFaults.0] | SNMP_AGENT | no delay |
...
| Status: Load Faults | MIB: PROSTAR-PWM<br>Description:Load Faults<br>Modbus address:0x002F | status.load_faults[loadFaults.0] | SNMP_AGENT | no delay |
...
| Battery: Target Voltage | MIB: PROSTAR-PWM<br>Description:Target Regulation Voltage<br>Scaling Factor:1.0<br>Units:V<br>Range:[0.0, 80.0]<br>Modbus address:0x0024 | target.voltage[targetVoltage.0] | SNMP_AGENT | no delay |
| Temperature: Ambient | MIB: PROSTAR-PWM<br>Description:Ambient Temperature<br>Scaling Factor:1.0<br>Units:deg C<br>Range:[-128, 127]<br>Modbus address:0x001C | temp.ambient[ambientTemperature.0] | SNMP_AGENT | no delay |
| Temperature: Battery | MIB: PROSTAR-PWM<br>Description:Battery Temperature<br>Scaling Factor:1.0<br>Units:deg C<br>Range:[-128, 127]<br>Modbus address:0x001B | temp.battery[batteryTemperature.0] | SNMP_AGENT | no delay |
| Temperature: Heatsink | MIB: PROSTAR-PWM<br>Description:Heatsink Temperature<br>Scaling Factor:1.0<br>Units:deg C<br>Range:[-128, 127]<br>Modbus address:0x001A | temp.heatsink[heatsinkTemperature.0] | SNMP_AGENT | no delay |
...
| ------------- |------------- |------------- |------------- |------------- |------------- |
| Battery: Device charge in critical state | HIGH | no description | last(/Morningstar ProStar PWM by SNMP/charge.state[chargeState.0])={$CHARGE.STATE.CRIT} | [{"tag": "scope", "value": "notice"}] | no url |
| Battery: Device charge in warning state | WARNING | no description | last(/Morningstar ProStar PWM by SNMP/charge.state[chargeState.0])={$CHARGE.STATE.WARN} | [{"tag": "scope", "value": "notice"}] | no url |
| Load: Device load in critical state | HIGH | no description | last(/Morningstar ProStar PWM by SNMP/load.state[loadState.0])={$LOAD.STATE.CRIT:"lvd"} or last(/Morningstar ProStar PWM by SNMP/load.state[loadState.0])={$LOAD.STATE.CRIT:"fault"} | [{"tag": "scope", "value": "notice"}] | no url |
| Load: Device load in warning state | WARNING | no description | last(/Morningstar ProStar PWM by SNMP/load.state[loadState.0])={$LOAD.STATE.WARN:"lvdWarning"}  or last(/Morningstar ProStar PWM by SNMP/load.state[loadState.0])={$LOAD.STATE.WARN:"override"} | [{"tag": "scope", "value": "notice"}] | no url |
| Status: Device has "arrayCurrentOffset" alarm flag | WARNING | no description | count(/Morningstar ProStar PWM by SNMP/status.alarms[alarms.0],#3,"like","arrayCurrentOffset")=2 | [{"tag": "scope", "value": "notice"}] | no url |
| Status: Device has "batterySenseDisconnected" alarm flag | WARNING | no description | count(/Morningstar ProStar PWM by SNMP/status.alarms[alarms.0],#3,"like","batterySenseDisconnected")=2 | [{"tag": "scope", "value": "notice"}] | no url |
| Status: Device has "batterySenseOutOfRange" alarm flag | WARNING | no description | count(/Morningstar ProStar PWM by SNMP/status.alarms[alarms.0],#3,"like","batterySenseOutOfRange")=2 | [{"tag": "scope", "value": "notice"}] | no url |
| Status: Device has "batteryTempOutOfRange" alarm flag | WARNING | no description | count(/Morningstar ProStar PWM by SNMP/status.alarms[alarms.0],#3,"like","batteryTempOutOfRange")=2 | [{"tag": "scope", "value": "notice"}] | no url |
| Status: Device has "controllerReset" alarm flag | WARNING | no description | count(/Morningstar ProStar PWM by SNMP/status.alarms[alarms.0],#3,"like","controllerReset")=2 | [{"tag": "scope", "value": "notice"}] | no url |
| Status: Device has "currentLimit" alarm flag | WARNING | no description | count(/Morningstar ProStar PWM by SNMP/status.alarms[alarms.0],#3,"like","currentLimit")=2 | [{"tag": "scope", "value": "notice"}] | no url |
| Status: Device has "currentMeasurementError" alarm flag | WARNING | no description | count(/Morningstar ProStar PWM by SNMP/status.alarms[alarms.0],#3,"like","currentMeasurementError")=2 | [{"tag": "scope", "value": "notice"}] | no url |
| Status: Device has "eepromAccessFailure" alarm flag | WARNING | no description | count(/Morningstar ProStar PWM by SNMP/status.alarms[alarms.0],#3,"like","eepromAccessFailure")=2 | [{"tag": "scope", "value": "notice"}] | no url |
| Status: Device has "fp10SupplyOutOfRange" alarm flag | WARNING | no description | count(/Morningstar ProStar PWM by SNMP/status.alarms[alarms.0],#3,"like","fp10SupplyOutOfRange")=2 | [{"tag": "scope", "value": "notice"}] | no url |
| Status: Device has "heatsinkTempLimit" alarm flag | WARNING | no description | count(/Morningstar ProStar PWM by SNMP/status.alarms[alarms.0],#3,"like","heatsinkTempLimit")=2 | [{"tag": "scope", "value": "notice"}] | no url |
| Status: Device has "heatsinkTempSensorOpen" alarm flag | WARNING | no description | count(/Morningstar ProStar PWM by SNMP/status.alarms[alarms.0],#3,"like","heatsinkTempSensorOpen")=2 | [{"tag": "scope", "value": "notice"}] | no url |
| Status: Device has "heatsinkTempSensorShorted" alarm flag | WARNING | no description | count(/Morningstar ProStar PWM by SNMP/status.alarms[alarms.0],#3,"like","heatsinkTempSensorShorted")=2 | [{"tag": "scope", "value": "notice"}] | no url |
...
| Status: Device has "dipSwitchChanged" load faults flag | HIGH | no description | count(/Morningstar ProStar PWM by SNMP/status.load_faults[loadFaults.0],#3,"like","dipSwitchChanged")=2 | [{"tag": "scope", "value": "notice"}] | no url |
